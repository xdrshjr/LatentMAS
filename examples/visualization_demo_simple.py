"""Simple demonstration of visualization tools (standalone version).

This script demonstrates the visualization tools without requiring
...
import torch
from methods.graph_structure import ReasoningGraph, ReasoningNode
from methods.path_manager import PathManager, PathState
from visualization.graph_viz import GraphVisualizer
from visualization.path_analysis import PathAnalyzer
from visualization.dashboard import ReasoningDashboard


def create_sample_graph():
    """Create a sample reasoning graph for demonstration."""
    print("Creating sample reasoning graph...")
...
def create_sample_paths():
    ...
    print(f"Created {len(manager.get_active_paths())} paths")
    return manager
...
def demo_path_analysis():
    ...
    print("  Logged pruning and merging events")
    ...
    try:
        ...
        print(f"  Note: Skipping plots (matplotlib not available)")
...
def demo_dashboard():
    ...
    # Update dashboard
    print("Updating dashboard with paths...")
    ...
    print("  Updated stats for 3 agents")
    
    # Update budget
    print("\nUpdating computational budget...")
    ...
    print("  Budget: 5000/10000 tokens (50%)")
...
def main():
    ...
    try:
        ...
        print("\nOptional (if matplotlib installed):")
        print("  - score_distribution.png (Score histogram)")
        print("  - diversity_over_time.png (Diversity timeline)")
        print("\n")
